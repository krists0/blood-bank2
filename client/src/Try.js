...
import AddDonorTab from './pages/tables/AddDonorTab';
import { Page, Text, View, Document, StyleSheet } from '@react-pdf/renderer';
import Button from './components/Button';
import ReactPDF from '@react-pdf/renderer';
import { PDFViewer } from '@react-pdf/renderer';
import MyDocument from "./MyDocument/index";
    ...
    return (
        <React.Fragment>
             ...
             <Grid maxWidth="lg">
                    ...
                    <Typography component="h1" variant="h4" align="center" style={{ color:'#ab003c',}} gutterBottom>
                                    Manage blood bank
                            </Typography>
                            <Typography variant="h6" align="center" style={{ color:'#ab003c',}} paragraph>
                               Add new donor, update , dalete and view list of donors , blood stock.
                               export to pdf file
                            </Typography>
                    <main>
                            ...
                            <Grid >
                                <Card className={classes.card} >
                                     ...
                                     <AddDonorTab donors={this.state.donors} />
                                </Card>
